...
class Mysql {
    ...
    public function __construct($config = array()) {
        ...
        $this->conn = mysql_connect("$host:$port", $user, $password) or die('Databse connection error');
        
        mysql_select_db($dbname) or die('Dabase selection error');
     ...
     * 
     *  @return row retun the value of this column
     */
